  ...
  \item Tangent and Normal Vectors to a Surface
    \begin{itemize}
      ...
      \item (Example) Find a parameterization for the sphere cenetered at
            the origin with radius \(3\). Show that the vector \((x,y,z)\)
            is normal to the sphere for each point \((x,y,z)\) on it.
            Then describe the plane tangent
            to it at the point \((1,-2,2)\) as an equation of \(x,y,z\).
    \end{itemize}
  \item\textit{
    HW: 1-3, 7-11
  }
  ...
  \item Stokes' Theorem
    \begin{itemize}
      ...
      \item (Example 3) Rewrite
        \(\iint_{S} (0,-ze^{xz},-2)\cdot\dvar\vect S\)
  ...
  \item Gauss'/Divergence Theorem
    \begin{itemize}
      ...
      \item
        ...
        \).
      \item (Example 3*) Evaluate \(\iint_S\<2y,zy,z^2\>\cdot\dvar\vect S\)
